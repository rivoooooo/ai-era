      ...
      <div className="w-full">
        {modules.map((module, index) => (
          <Link
            ...
            className="flex items-center gap-3 py-2 px-3 hover:bg-primary hover:text-primary-foreground transition-all duration-100 cursor-pointer group"
          >
            ...
            <span className="text-muted-foreground text-[12px] hidden lg:block group-hover:text-primary-foreground">
